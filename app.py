...
QUESTIONS = [
    {
        ...
        "options": [
            ...
            "Model Compute Pipeline",
        ],
        "correct": 0,
    },
    {
        "question": "In the MCP architecture, which component actually holds the AI application, like Claude or VS Code?",
        "options": [
            "MCP Host",
            "MCP Client",
            "MCP Server",
    ...
    {
        "question": "What is the role of the MCP Client?",
        "options": [
            "It handles communication between the Host and the Server",
            "It stores the company's data",
            "It runs the AI model",
            "It exposes tools to external systems",
        ],
        "correct": 0,
    },
    {
        "question": "Which Snowflake MCP tool would you use to answer a question using documents like PDFs or policies?",
        "options": [
    ...
    {
        "question": "Which Snowflake MCP tool can combine multiple tools together to answer a complex question?",
        "options": [
            "CORTEX_AGENT_RUN",
            "SYSTEM_EXECUTE_SQL",
            "GENERIC",
    ...
    {
        "question": "In the live demo, why did the 'Delete the customer tables' request fail?",
        "options": [
            "The AI only had permission to read data, not change or delete it",
            "Claude Desktop was not connected to the internet",
            "Snowflake does not support delete commands",
            "The MCP server was turned off",
        ],
        "correct": 0,
    },
    {
        "question": "In the Banking AI Assistant example, what does the AI use to make sure it only accesses data the user is allowed to see?",
        "options": [
            "Governed access through Snowflake privileges",
            "The user's email password",
            "A separate banking login system",
            "Claude's own internal memory",
        ],
        "correct": 0,
    },
]
